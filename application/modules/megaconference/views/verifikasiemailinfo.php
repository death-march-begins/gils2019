				...
				<center style="width: 100%;">
					...
					<div style="max-width: 600px;">
						...
						<table align="center" width="600" class="email-container">
							<tr>
								<td class="img" style="padding: px; text-align: center"><img src="https://i.ibb.co/fGW8YdZ/Header2.png"
										width="600" height="150" alt="alt_text" border=""></td>
							</tr>
						</table>
								...
								<td bgcolor="#ffffff" valign="middle"
														...
														<div
															...
															<div
																...
																<div
																	...
																	<p
																		style="font-size: 14px; line-height: 1.2; text-align: center; mso-line-height-alt: 17px; margin: 0;">
																		Berikut adalah detail reservasi yang telah dilakukan :</p>
																</div>
															</div>
									...
									<div style="background-color:transparent;">
										<div class="block-grid mixed-two-up"
											...
											<div style="border-collapse: collapse;display: table;width: 100%;background-color:#F04E2C;">
												...
												<div class="col num8"
													...
													<div style="width:100% !important;">
														...
														<div
															...
															<div
																style="color:#FFFFFF;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;line-height:1.2;padding-top:10px;padding-right:20px;padding-bottom:10px;padding-left:20px;">
																<div
														...
														<div
															...
															<div
																...
																<div
																	style="font-size: 12px; line-height: 1.2; font-family: 'Lato', Tahoma, Verdana, Segoe, sans-serif; color: #FFFFFF; mso-line-height-alt: 14px;">
																	<p style="font-size: 14px; line-height: 1.2; mso-line-height-alt: 17px; margin: 0;">
																		<span style="font-size: 14px;">HARGA</span><br /></p>
																</div>
															</div>
												...
												<div class="col num8"
													...
													<div style="width:100% !important;">
														...
														<div
															...
															<div
																style="color:#000000;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;line-height:1.2;padding-top:10px;padding-right:20px;padding-bottom:10px;padding-left:20px;">
																<div
					...
					<div style="color:#71777D;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;line-height:1.2;padding-top:10px;padding-right:10px;padding-bottom:0px;padding-left:10px;">
						<div
							...
							<p style="font-size: 14px; line-height: 1.2; text-align: center; mso-line-height-alt: 17px; margin: 0;">
								Mohon untuk membayar biaya registrasi pada rekening berikut :</p><br>
							<p
								style="font-size: 16px; line-height: 1.2; font-family: prototype; text-align: center; color: black; mso-line-height-alt: 17px; margin: 0;">
								BNI <u>0839984966</u> a.n. Mayang Arnindika Prameswari
							</p><br>
							<p
								style="font-size: 14px; line-height: 1.2; text-align: center; mso-line-height-alt: 17px; margin: 0; color:#71777D;">
								Informasi lebih lanjut dapat hubungi contact person di bawah ini :</p>
						</div>
					</div>
						...
						<td>
							...
							<div style="background-color:transparent;">
								<div class="block-grid three-up"
									...
									<div style="border-collapse: collapse;display: table;width: 100%;background-color:#79C5B9;">

										<table align="left" width="600" class="email-container">
											<tr>
												<td
													style="padding: 0px 0px 20px 20px;width: 100%;font-size: 15px; font-family: roboto; mso-height-rule: exactly; line-height:18px; text-align: left; color: #000000;">
													<br>
													<p style="margin-bottom: -10px;"><b>Contact Person :</b></p><br>
													+62 812-4981-2473 (Mayang)<br>
